...
@section('content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ url('/categories/create') }}" class="btn btn-success btn-sm" title="Add New Contact">
                    ...
                    <table class="table">
                        ...
                        @foreach($categories as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/categories/' . $item->id) }}" title="View Student"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
