...
@section('content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ url('/sellers_permissions/create') }}" class="btn btn-success btn-sm" title="Add New Contact">
                    ...
                    <table class="table">
                        ...
                        @foreach($sellers_permissions as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/sellers_permissions/' . $item->id) }}" title="View Student"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                    <a href="{{ url('/sellers_permissions/' . $item->id . '/edit') }}" title="Edit Student"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
