                        ...
                        <div class="card-body">
                            <form action="{{ route('student/update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Tanggal Registration</label>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Nomor Telepom</label>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <button type="button" class="btn btn-light"><a href="{{ route('all/student/list') }}">Kembali</a></button>
                                    </div>
                                </div>
                            </form>
                        </div>
